        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    Patient me = hb.Patients.FirstOrDefault(x => x.emailId == model.Email);
                    Staff se = hb.Staffs.FirstOrDefault(x => x.emailId == model.Email);
                    if(me != null )
                    {
                        Session.Add("userId", me.patientId.ToString());
                    }
                    if(se!=null)
                    {
                        Session.Add("userId", se.staffId.ToString());
                    }
